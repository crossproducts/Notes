                                                                                                                ...
                                                                                                                - - **Key hyperparameters**:
                                                                                                                  -   - Learning rate (most impactful)
                                                                                                                      -   - Number of trees / depth (tree models)
                                                                                                                          -   - Epochs and batch size (neural networks)
                                                                                                                                  ...
                                                                                                                                  -   - Dropout rate
                                                                                                                                      - - **Warm start**: Re-use prior tuning job results to speed up new HPO runs.
                                                                                                                                        ...
                                                                                                                                        - ```
                                                                                                                                          ...
                                                                                                                                          - **Pre-training bias**: Measures bias in raw dataset before model is trained.
                                                                                                                                          -   - Class Imbalance (CI), Difference in Proportions of Labels (DPL)
                                                                                                                                              - - **Post-training bias**: Measures bias in model predictions.
                                                                                                                                                -   - DPPL, DI (Disparate Impact), FT (Flip Test)
                                                                                                                                                    - - **Explainability**: SHAP values indicate each feature's contribution to a prediction.
                                                                                                                                                      - - Use Clarify in SageMaker Pipelines to automate bias checks as a pipeline step.
                                                                                                                                                        ...
                                                                                                                                                        - ```
                                                                                                                                                          ...
                                                                                                                                                          |---|---|
                                                                                                                                                          | **Real-Time Endpoint** | Low-latency, synchronous predictions (<1s) |
                                                                                                                                                                ...
                                                                                                                                                                - - **A/B Testing**: Two versions run simultaneously to compare performance (SageMaker supports weighted variant routing).
                                                                                                                                                                  - - **Shadow Mode**: New model receives traffic copy but responses not served to user; safe comparison.
                                                                                                                                                                    ...
                                                                                                                                                                    - ```
                                                                                                                                                                      ...
                                                                                                                                                                      ├── Instant cutover with rollback
                                                                                                                                                                      │   └── Blue/Green
                                                                                                                                                                      ├── Compare two model versions live
                                                                                                                                                                      │   └── A/B Testing (variant weights)
                                                                                                                                                                      ├── Test new model without user impact
                                                                                                                                                                      │   └── Shadow Mode
                                                                                                                                                                      └── Update fleet progressively
                                                                                                                                                                          └── Rolling Deployment
                                                                                                                                                                      ```
...
| Amazon Athena | SQL on S3 || Amazon Kinesis | Real-time data streaming |
